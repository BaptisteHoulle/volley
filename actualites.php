...
<body class="actus">
    ...
    <main>
        ...
        if (isset($tableau[0])) {
            affichePost($tableau[0], $liste_images);
        }
        if (isset($tableau[1])) {
            affichePost($tableau[1], $liste_images);
        }
        if (isset($tableau[2])) {
            affichePost($tableau[2], $liste_images);
        }

        if ((isset($tableau[0]) == false) || (isset($tableau[1]) == false) || (isset($tableau[2]) == false)) {
        ...
        <div class="actus_pagination">
            <span class="actus_pagination_actif">1</span>
            <span class="actus_pagination_page"><a href="actualites2.php">2</a></span>
            <span class="actus_pagination_page"><a href="actualites3.php">3</a></span>
        </div>
    </main>
    ...
    <script src="scripts/nouvelle_actu.js"></script>
    <script>
        $(function () {
