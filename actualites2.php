...
<body class="actus">
    ...
    <main>
        ...
        if (isset($tableau[3])) {
            affichePost($tableau[3], $liste_images);
        }
        if (isset($tableau[4])) {
            affichePost($tableau[4], $liste_images);
        }
        if (isset($tableau[5])) {
            affichePost($tableau[5], $liste_images);
        }

        if ((isset($tableau[3]) == false) || (isset($tableau[4]) == false) || (isset($tableau[5]) == false)) {
        ...
        <div class="actus_pagination">
            ...
            <span class="actus_pagination_actif">2</span>
